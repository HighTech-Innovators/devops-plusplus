# Measure Efficiency in User Terms — Core

This section explains the **core idea** of the principle.

**Definition**:  
Measure Efficiency in User Terms ensures teams focus on solving the right problems in sustainable, cost-efficient ways.
